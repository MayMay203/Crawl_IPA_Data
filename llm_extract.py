...
async def main():
    ...
    url = "https://investdanang.gov.vn/web/guest"
    ...
    async with AsyncWebCrawler(config=browser_config) as crawler:
        ...
        if hasattr(result, 'extracted_content') and result.extracted_content:
            ...
            try:
                ...
                # Debug usage manually
                if hasattr(llm_strategy, 'responses'):
                    for r in llm_strategy.responses:
                        try:
                            print("Usage:", r.get("usage"))
                        except Exception as e:
                            print("Error reading usage:", e)
